...
// ─── Production stability constants ──────────────────────────────────────────
...
// Configuration write optimization
...
<div class="card fcrd">
<div class="alert ai">&#x26A0;&#xFE0F; Pin changes require device restart. Reserved pins: D0(GPIO16), D4(GPIO2), SD2(GPIO9), SD3(GPIO10)</div>
...
const pinNames={16:'D0',5:'D1',4:'D2',0:'D3',2:'D4',14:'D5',12:'D6',13:'D7',15:'D8',3:'RX',1:'TX',9:'SD2',10:'SD3'};
const validPins=[16,5,4,0,14,12,13,3,1,15,2,9,10];
...
void updateStatusLED() {
    ...
    } else if (!rtcInitialized || (lastNTPSync == 0)) {
...
void handleGetTime() {
    ...
    server.send(200, "application/json", "{\"time\":\"" + ts + "\",\"wifi\":" + String(wifiConnected ? "true" : "false") + ",\"ntp\":" + String((lastNTPSync > 0) ? "true" : "false") + "}");
}
