...
// =============================================================================
//  CONFIGURATION  (load / save / migrate v1→v3 + ExtConfig)
// =============================================================================
...
void loadConfiguration() {
    ...
    if (sysConfig.magic != EEPROM_MAGIC) {
        ...
        Serial.println("[CFG] Migrating v2 → v3");
        ...
        Serial.println("[CFG] Migrating v1 → v3 (4→8 schedules + hostname)");
