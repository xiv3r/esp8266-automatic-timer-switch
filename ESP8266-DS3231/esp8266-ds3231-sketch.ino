/*
============================================================
 *  ESP8266 9-Channel Relay Smart Switch
...
// ─── Relay config ────────────────────────────────────────────────────────────
#define NUM_RELAYS 9
const int  relayPins[NUM_RELAYS] = { D0, D3, D4, D5, D6, D7, D8, 3, 1 };
...
void syncFromDS3231() {
    ...
    // Also update the DS3231's time if NTP is available and more accurate
    if (wifiConnected && timeClient.getEpochTime() > 1000000000UL) {
        // DS3231 has priority, but we keep internal RTC synced
    }
}
...
void setup() {
    ...
    // Initialize relay pins (9 channels)
