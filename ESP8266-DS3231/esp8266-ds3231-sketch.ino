/*
============================================================
 *  ESP8266 7-Channel Relay Smart Switch w/ LED Status Indicator
 *  Author: Raff Alds
...
char ap_ssid[32]     = "ESP8266_7CH_Timer_Switch";
...
<header>
<span class="logo">&#x26A1; ESP8266 7-CH</span>
<nav>
...
void tryNTPSync() {
    ...
    if (ds3231Available && lastNTPSync > 0 && millis() - lastNTPSync < 43200000UL) { 
        return;
    }
...
void initDefaults() {
    ...
    strcpy(sysConfig.ap_ssid, "ESP8266_7CH_Timer_Switch");
