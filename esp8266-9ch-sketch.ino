 ...
 *  MODIFIED: Soft Recovery System - No Hardware Restart
============================================================
 */
...
void executeRecovery() {
    ...
    static unsigned long lastSuccessfulRecovery = 0;
    if (millis() - lastSuccessfulRecovery > 3600000UL) {
        recoveryAttempts = 0;
        lastSuccessfulRecovery = millis();
    }
}
