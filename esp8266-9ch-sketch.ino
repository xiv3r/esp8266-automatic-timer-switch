...
// FIXED PINS HTML - with proper pin availability tracking
...
<div class="card fcrd">
<div class="alert ai">&#x26A0;&#xFE0F; Pin changes require device restart. Reserved pins: D4(GPIO2), D8(GPIO15)</div>
...
const allValidPins = [16, 5, 4, 0, 14, 12, 13, 3, 1];
const pinNames={16:'D0',5:'D1',4:'D2',0:'D3',14:'D5',12:'D6',13:'D7',3:'RX',1:'TX'};
...
void initDefaults() {
    ...
    pinConfig.numRelays = 9;
    pinConfig.globalActiveLow = true;
    numRelays = 9;
    relayActiveLow = true;    
    uint8_t defaultPins[] = {16, 5, 4, 0, 14, 12, 13, 3, 1};    
